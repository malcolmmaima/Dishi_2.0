...
import com.malcolmmaima.dishiapp.View.Fragments.ReviewsFragment;
import com.malcolmmaima.dishiapp.View.Fragments.ViewRestaurantMenuFragment;
...
public class ViewRestaurant extends AppCompatActivity {
    ...
    private void loadActivity() {
        ...
        restaurantRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists()){
                    finish();
                    Toast.makeText(ViewRestaurant.this, "Restaurant no longer exists!", Toast.LENGTH_LONG).show();
                } else {
        ...
        mylocationListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    computeDistance(restaurantPhone);
                } catch (Exception e){
        ...
        shareRest.setVisibility(View.GONE);
    ...
    private void computeDistance(String restaurantPhone) {
