...
import com.malcolmmaima.dishiapp.View.Fragments.MyRestaurantsFragment;
...
import com.malcolmmaima.dishiapp.View.Fragments.RiderRequestsFragment;
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try {
                        ...
                        if(user.getProfilePicSmall() != null){
                            Picasso.with(RiderActivity.this).load(user.getProfilePicSmall()).fit().centerCrop()
