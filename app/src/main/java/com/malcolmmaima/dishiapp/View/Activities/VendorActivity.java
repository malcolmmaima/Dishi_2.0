...
import com.malcolmmaima.dishiapp.View.Fragments.MenuFragment;
import com.malcolmmaima.dishiapp.View.Fragments.MyReviewsFragment;
import com.malcolmmaima.dishiapp.View.Fragments.MyRidersFragment;
import com.malcolmmaima.dishiapp.View.Fragments.ReceiptsFragment;
import com.malcolmmaima.dishiapp.View.Fragments.RestaurantOrdersFragment;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    if(!user.getAccount_type().equals("2")){
                        Toast.makeText(VendorActivity.this, "Not allowed!", Toast.LENGTH_LONG).show();
                        finish();
                    }
