...
import com.malcolmmaima.dishiapp.Model.AbuseReportModel;
...
public class ReportAbuse extends AppCompatActivity {
    ...
    int selectedOption;
    String reportType, productOwner, productKey, author, postedTo, statusKey,commentKey, reviewKey, myPhone, userReported;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mAuth.getInstance().getCurrentUser() == null){
            ...
            if(reportType.equals("userReport")){
                userReported = getIntent().getStringExtra("user");
            }
            ...
            reportBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(reportType.equals("userReport")){
                        DatabaseReference userReportsRef = FirebaseDatabase.getInstance().getReference("reports/users/"+userReported+"/userReports/"+myPhone);
