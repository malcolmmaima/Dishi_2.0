...
import com.malcolmmaima.dishiapp.View.Adapter.ReviewReplyAdapter;
...
public class ViewReview extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    DatabaseReference reviewsRef, authorUserDetailsRef, myRef;
                    ...
                    if(dataSnapshot.exists()){
                        myRef.child("appLocked").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if(locked == true){
                                    Intent slideactivity = new Intent(ViewReview.this, SecurityPin.class)
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    if(authorUser.getProfilePicSmall() != null){
                        Picasso.with(ViewReview.this).load(authorUser.getProfilePicSmall()).fit().centerCrop()
