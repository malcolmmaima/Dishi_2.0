...
import com.malcolmmaima.dishiapp.View.Adapter.StatusUpdateAdapter;
...
public class ViewProfile extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onDestroy() {
        ...
        try { myBlockedUsers.removeEventListener(blockedUsersListener); } catch (Exception e){ }

        try { posts.removeEventListener(postUpdatesListener); } catch (Exception e){
