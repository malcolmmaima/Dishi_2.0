...
public class GeoTracking extends AppCompatActivity implements OnMapReadyCallback {
    ...
    String myPhone, accType, message, callMsg, nduthi_phone, nduthiNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            nduthiNumber = getIntent().getStringExtra("nduthi_phone");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        nduthiGuyRef[0] = FirebaseDatabase.getInstance().getReference("location/"+nduthi_phone);
